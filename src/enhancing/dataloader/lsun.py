...
class LSUNBase(LSUN):
    def __init__(
        self, root: str, classes: Union[Tuple[str, str]], transform: Optional[Callable] = None
    ) -> None:
...
class LSUNTrain(LSUNBase):
    def __init__(
        self, root: str, classes: Union[Tuple[str, str]], resolution: Union[Tuple[int, int], int] = 256
    ) -> None:
        transform = T.Compose(
