...
class SimpleTokenizer:
    def __init__(
        self, bpe_path: str = default_bpe(), text_length: int = 256, truncate_captions: bool = True
    ) -> None:
    ...
    def decode(
        self, tokens: List[int], remove_start_end: bool = True, pad_tokens: Optional[Set] = set()
    ) -> str:
